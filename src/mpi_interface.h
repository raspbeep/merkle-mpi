...
/**
 * @brief Tag for Merkel tree data validation messages.
 * 
 * Tag used for Merkel tree data validation messages in MPI communication.
 */
...
/**
 * @brief MPI_Send wrapper that sends data and verifies its integrity using a Merkel tree.
 * 
...
/**
 * @brief MPI_Recv wrapper that receives data and verifies its integrity using a Merkel tree.
 *
 * @param buf Pointer to the data buffer.
 * @param count Number of elements in the buffer.
 * @param datatype MPI datatype of the elements.
...
/**
 * @brief MPI_Bcast wrapper that transfers data and verifies its integrity using a Merkel tree.
 *
...
/**
 * @brief MPI_Allgather wrapper that transfers data and verifies its integrity using a Merkel tree.
 *
 ...
 *
 * @param tree Local merkel tree of each rank.
